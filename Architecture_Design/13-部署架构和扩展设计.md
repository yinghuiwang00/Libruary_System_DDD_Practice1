...
项目采用 **单体模块化** 架构（monolith-first），所有 7 个上下文在同一进程中运行。

**开发环境基础设施**:

| 组件 | 配置 |
|------|------|
| PostgreSQL | 端口 5432, 用户 postgres |
| Kafka | 主机端口 29092, 容器端口 9092 |
| Kafka UI | http://localhost:9000 |
| Redis | 端口 6379 |
| Prometheus | http://localhost:9090 |
| Grafana | http://localhost:3000, 用户 admin |
...
| 模块 | 端口 |
|------|------|
| library-catalog | 8081 |
| library-inventory | 8082 |
| library-circulation | 8083 |
| library-patron | 8084 |
| library-payment | 8085 |
| library-analytics | 8086 |
| library-notification | 8087 |
...
| 设计项 | 状态 | 说明 |
|--------|------|------|
| Spring Cloud Gateway | ❌ 未实现 | 当前为单体架构，无需网关 |
| Service Discovery | ❌ 未实现 | 同上 |
| Circuit Breaker | ❌ 未实现 | 同上 |
| Docker Compose | ✅ 部分实现 | 基础设施组件已有 compose 配置 |
| Prometheus + Grafana | ✅ 已配置 | 监控指标和仪表盘就绪 |
| Jaeger Tracing | ✅ 已配置 | OpenTelemetry + Jaeger 就绪 |
| Kafka 集群 | ✅ 已实现 | 5 个 Topic, 12 Consumer, 7 Publisher |
