...
@Component("paymentDomainEventPublisher")
public class PaymentDomainEventPublisher {

    private static final Logger log = LoggerFactory.getLogger(PaymentDomainEventPublisher.class);

    private final DomainEventPublisher localPublisher;
    private final KafkaTemplate<String, DomainEvent> kafkaTemplate;
    private final String topicName;

    public PaymentDomainEventPublisher(
        ...
        this.topicName = environment.getProperty(
            "spring.kafka.topic.domain-events", "library.payment.events");
    }
