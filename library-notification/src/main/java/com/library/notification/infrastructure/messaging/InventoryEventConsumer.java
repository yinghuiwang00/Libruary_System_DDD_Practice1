...
@Component("notificationInventoryEventConsumer")
public class InventoryEventConsumer {
    private static final Logger log = LoggerFactory.getLogger(InventoryEventConsumer.class);
    private final ObjectMapper objectMapper;
    private final LowStockNotificationHandler lowStockHandler;

    public InventoryEventConsumer(ObjectMapper objectMapper, LowStockNotificationHandler lowStockHandler) {
        this.objectMapper = objectMapper; this.lowStockHandler = lowStockHandler;
    }

    @KafkaListener(topics = "library.inventory.events", groupId = "library.notification.consumer.inventory")
