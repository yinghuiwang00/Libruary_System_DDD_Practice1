...
public class InventoryDomainEventPublisher {
    ...
    private static final Logger log = LoggerFactory.getLogger(InventoryDomainEventPublisher.class);

    private final DomainEventPublisher localPublisher;
    private final KafkaTemplate<String, DomainEvent> kafkaTemplate;
    private final String topicName;

    public InventoryDomainEventPublisher(
        ...
        this.topicName = environment.getProperty(
            "spring.kafka.topic.domain-events", "library.inventory.events");
    }
