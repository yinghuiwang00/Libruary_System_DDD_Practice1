...
@Component("circulationDomainEventPublisher")
public class CirculationDomainEventPublisher {

    private static final Logger log = LoggerFactory.getLogger(CirculationDomainEventPublisher.class);

    private final DomainEventPublisher localPublisher;
    private final KafkaTemplate<String, DomainEvent> kafkaTemplate;
    private final String topicName;

    public CirculationDomainEventPublisher(
        ...
        this.topicName = environment.getProperty(
            "spring.kafka.topic.domain-events", "library.circulation.events");
    }
