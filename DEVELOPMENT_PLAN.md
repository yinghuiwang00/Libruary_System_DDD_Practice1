...
> **创建日期**: 2026-05-03
> **最后更新**: 2026-06-03
> **状态**: 阶段一~十全部完成 ✅ — 318 源文件, 163 测试文件, 46 BDD Feature, CI 已配置 | 后续可选：API 网关、监控、容器化
...
| 指标 | 数值 |
|------|------|
| Maven 模块 | 11（7 上下文 + shared + e2e-test + integration-test + staging-test） |
| 主代码 Java 文件 | 318 |
| 测试 Java 文件 | 163 |
| BDD Feature 文件 | 46 |
| 聚合根 | 15 |
...
| `docs/reference/` | 操作参考手册（兼容性规则、开发检查清单、测试指南、CI 详情） |
| `docs/guides/` | 步骤指南（本地环境搭建、新建 Bounded Context、故障排查） |
