...
/**
 * Step definitions for borrow-book-inventory feature.
 * Verifies that BookBorrowedEvent updates inventory copy status.
 */
public class BorrowBookInventorySteps {
    ...
    public void createBookWithInventory(String bookId, String libraryCode) {
        ...
        BookCopy copy = inventory.addCopy("BAR-INV-001", Location.simple(libraryCode, "A01-A-001"), "SYSTEM");
